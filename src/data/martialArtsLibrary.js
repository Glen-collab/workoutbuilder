...
export const defaultBeltSystem = {
  ...
  belts: [
    { id: 'white', name: 'White Belt', color: '#ffffff', textColor: '#333', tier: 1, geup: 10, form: 'Kicho Il Jang' },
    { id: 'high-white', name: 'High White Belt', color: '#f5f5f5', textColor: '#333', tier: 1, geup: 9, form: null },
    { id: 'yellow', name: 'Yellow Belt', color: '#FFD700', textColor: '#333', tier: 1, geup: 8, form: 'Taegeuk Il Jang' },
    { id: 'high-yellow', name: 'High Yellow Belt', color: '#FFC107', textColor: '#333', tier: 1, geup: 7, form: null },
    { id: 'green', name: 'Green Belt', color: '#4CAF50', textColor: '#fff', tier: 2, geup: 6, form: 'Taegeuk Sam Jang' },
    { id: 'high-green', name: 'High Green Belt', color: '#388E3C', textColor: '#fff', tier: 2, geup: 5, form: null },
    { id: 'blue', name: 'Blue Belt', color: '#2196F3', textColor: '#fff', tier: 3, geup: 4, form: 'Taegeuk Sa Jang' },
    { id: 'high-blue', name: 'High Blue Belt', color: '#1565C0', textColor: '#fff', tier: 3, geup: 3, form: null },
    { id: 'red', name: 'Red Belt', color: '#F44336', textColor: '#fff', tier: 4, geup: 2, form: 'Taegeuk Oh Jang' },
    { id: 'high-red', name: 'High Red Belt', color: '#C62828', textColor: '#fff', tier: 4, geup: 1, form: 'Taegeuk Yook Jang' },
    { id: 'deputy', name: 'Deputy Black Belt', color: '#333', textColor: '#fff', tier: 5, geup: 0, form: 'Taegeuk Chil Jang' },
    { id: 'black', name: 'Black Belt', color: '#000', textColor: '#fff', tier: 5, dan: 1, form: 'Koryo' },
  ],
};
