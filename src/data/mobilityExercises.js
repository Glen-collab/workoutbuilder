...
export const mobilityCategories = {
    ...
    // (WARMUP_PRESETS day-flows + WARMUP_DRILLS video drills = SPRINT_WARMUP).
    // The same set shows in the Movement, Mobility, and Warm Up blocks.
    sprint_warmup: {
        label: "Sprint Warmup",
    ...
    hip_mobility: {
        ...
        exercises: [
            ...
            { name: 'Hurdle Mobility', duration: '1 round', description: 'Full hurdle mobility flow — walks, skips, and pass-throughs', youtube: 'https://iframe.videodelivery.net/aae027bd0686916ad595c16619d53a7d' },
            ...
            { name: 'Butterfly Stretch', duration: '60s', description: 'Hip adductor mobility', youtube: 'https://iframe.videodelivery.net/a2a0a2a3c868f34c9c11f0dad76e8193' },
    ...
    full_body_mobility: {
        ...
        exercises: [
            ...
            { name: 'Lateral Bear Crawl', duration: '10 yards each side', description: 'Side-traveling bear crawl — hip and shoulder mobility', youtube: 'https://iframe.videodelivery.net/8986cbdeac0c0b9b5b83f03de23ffee7' },
            { name: 'Crab Walk', duration: '20 yards each', description: 'Reverse tabletop crab walk — shoulder extension + hip opener', youtube: 'https://iframe.videodelivery.net/f14554508cc7c63b6c6da061834d37fd' },
            ...
            { name: 'Duck Walk', duration: '15 yards', description: 'Deep squat walk — hip, knee and ankle mobility', youtube: 'https://iframe.videodelivery.net/850e42db5828b206d15d37b28a96c48a' },
    ...
    flexibility: {
        ...
        exercises: [
            ...
            { name: 'Butterfly Stretch', duration: '60s', description: 'Adductor and groin flexibility', youtube: 'https://iframe.videodelivery.net/a2a0a2a3c868f34c9c11f0dad76e8193' },
