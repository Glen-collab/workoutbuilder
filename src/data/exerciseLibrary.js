        ...
        subcategories: {
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Single Arm Cable Row', movement: ['Pull'], intent: ['Stability'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    ...
                    { name: 'Rope Pull Through', movement: ['Pull', 'Hip Hinge'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    { name: 'Squat Single Arm Cable Row', movement: ['Pull'], intent: ['Stability'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    { name: 'Squat Position V-Bar Row', movement: ['Pull'], intent: ['Stability'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    { name: 'V-Bar Row', movement: ['Pull'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' }
                ]
            },
            machine: {
                label: "Machine",
                exercises: [
                    ...
                    { name: 'Straight Bar Seated Row', movement: ['Pull'], intent: ['Hypertrophy'], equipment: ['Machine'], contraindications: [], youtube: '' }
                ]
            },
            corrective: {
                label: "Corrective",
                exercises: [
                    ...
                    { name: 'Face Pulls', movement: ['Pull'], intent: ['Stability', 'Posture'], equipment: ['Cable', 'Band'], contraindications: [], youtube: '', geriatric_priority: true },
        ...
        subcategories: {
            ...
            cable: {
                ...
                exercises: [
                    ...
                    // --- No video ---
                    { name: 'Cable Curl', movement: ['Pull'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    { name: 'Cable Hammer Curl (Rope)', movement: ['Pull'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    { name: 'Cable Preacher Curl', movement: ['Pull'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' },
                    ...
                    { name: 'Cable Tricep Kickback', movement: ['Push'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: '' },
        ...
        subcategories: {
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Wall Sit', movement: ['Squat'], intent: ['Stability', 'Hypertrophy'], equipment: ['Bodyweight'], contraindications: ['Lower Body Load Limited'], youtube: 'https://iframe.videodelivery.net/699d7608fad31030d5695395e32872d6', geriatric_priority: true },
                    { name: 'Calf Raises (Bodyweight)', movement: ['Push'], intent: ['Hypertrophy', 'Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9267420c6b648628992afe24cf28b4af', geriatric_priority: true },
            ...
            bands: {
                ...
                exercises: [
                    { name: 'Band Lateral Walk', movement: ['Gait'], intent: ['Corrective', 'Stability'], equipment: ['Bands'], contraindications: [], youtube: 'https://iframe.videodelivery.net/072732eeeed5daed8d25381a8d282a56', geriatric_priority: true },
                    { name: 'Band Monster Walk', movement: ['Gait'], intent: ['Corrective', 'Stability'], equipment: ['Bands'], contraindications: [], youtube: 'https://iframe.videodelivery.net/56d53d054b666771d49e192a6defaa41', geriatric_priority: true },
            ...
            corrective: {
                ...
                exercises: [
                    ...
                    { name: 'Stability Ball Plank', movement: ['Brace'], intent: ['Stability'], equipment: ['Stability Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8a06d797374125f05fe8e3f6fc427cc5', geriatric_priority: true },
