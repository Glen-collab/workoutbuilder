        ...
        subcategories: {
            barbell: {
                ...
                exercises: [
                    ...
                    { name: 'Floor Press (Barbell)', movement: ['Push'], intent: ['Strength'], equipment: ['Barbell'], contraindications: ['Upper Body Load Limited', 'ROM Restricted'], youtube: 'https://iframe.videodelivery.net/272361d1aa9437b36433f76f4c885f60' },
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Decline/Box Scap Pushups', movement: ['Push'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0e179c089b5afc1dab6cd19b96abd67e' },
        ...
        subcategories: {
            barbell: {
                ...
                exercises: [
                    ...
                    { name: 'Trap Bar Deadlift', movement: ['Hinge'], intent: ['Max Strength', 'Hypertrophy'], equipment: ['Barbell'], contraindications: ['No Axial Loading', 'Lower Body Load Limited'], youtube: 'https://iframe.videodelivery.net/47710ba9bf7025a08c2eeb96b5cc10cc' },
                    ...
                    { name: 'Bar Stiff Leg Deadlift Stretch', movement: ['Hinge', 'Mobility'], intent: ['Mobility', 'Flexibility'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/709d552d96c16957b42558114af649e3' }
                ]
            },
            dumbbell: {
                label: "Dumbbell",
                exercises: [
                    ...
                    { name: 'Goblet Squat to Box', movement: ['Squat'], intent: ['Technique'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ba8da605933cee3b1a1a6ea9d83644b9', geriatric_priority: true },
            ...
            functional: {
                label: "Functional",
                exercises: [
                    { name: 'Plate Overhead Split Squat', movement: ['Squat'], intent: ['Stability'], equipment: ['Plate'], contraindications: [], youtube: 'https://iframe.videodelivery.net/aa1fb12936e917ff0c8d6f94bc7c4c57' },
                    { name: 'Squat and Reach Up side to side', movement: ['Squat'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6c2cf3eb4c7e9c08c795f5bae006b52e' },
                    { name: 'Glute Extension Reach Backs', movement: ['Hip'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4dd740b3892a32e4d5b11b9c2c6ee68c' },
                    { name: 'RDL Hip Openers', movement: ['Hinge'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/45319b53533cdbf2d75d3e9272119d6d' },
                    { name: 'Waiter Hold Opposite Knee Up Balance', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1db089338fca03977928d952b43a21d4' },
                    { name: 'Standing Hip Circles with Balance', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/260b5207f6df7ece0b4bf82a4b0bbeec' },
                    { name: 'Band Single Leg Hamstring Curl', movement: ['Hinge'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/2b3ddd206cee534bda4da4a186fa8904' },
                    { name: 'Dumbbell Step Behind Curtsy Lunge', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ebd85cd992cee0eee972dfd8c75ea0ae' },
                    ...
                    // --- New uploads 2026-06-20 (functional locomotion / movement) ---
                    { name: 'Spiderman Walk', movement: ['Lunge', 'Mobility'], intent: ['Mobility', 'Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/67d345e8a5e4f93f9a31a4bc79361cac' },
                    { name: 'Duck Walk', movement: ['Squat'], intent: ['Mobility', 'Endurance'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/850e42db5828b206d15d37b28a96c48a' },
                    { name: 'Supine Cross Toe to Hand', movement: ['Core', 'Mobility'], intent: ['Mobility', 'Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/71bf7b53ad5cdf03002f260a6067ad2f' },
                    { name: 'Scorpions', movement: ['Rotation', 'Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9b0747238d86d32888952e483ebfb38f' },
                    { name: 'Bear to Crab', movement: ['Mobility'], intent: ['Mobility', 'Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6b2c8cea2ca410b1fa412f56e945bc91' },
                    { name: 'Crab Walk Position Toe Touches', movement: ['Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8f13f6c26a162835962c439ec5ff85d1' },
                    { name: 'Crab Walk', movement: ['Mobility'], intent: ['Mobility', 'Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/f14554508cc7c63b6c6da061834d37fd' },
                    { name: 'Lateral Bear Crawl', movement: ['Mobility'], intent: ['Mobility', 'Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8986cbdeac0c0b9b5b83f03de23ffee7' },
                    { name: 'Walking Lateral Lunge Stretch', movement: ['Lunge', 'Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/329a6b122f32bdaefc15a450f3b2f0f3' },
                    { name: 'Walking RDL', movement: ['Hinge', 'Balance'], intent: ['Mobility', 'Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3d48938c0141495ee867ebd13d4ac418' }
                ]
            },
            machine: {
                label: "Machine",
        ...
        subcategories: {
            upper: {
                ...
                exercises: [
                    ...
                    { name: 'Plank March', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/629f467f62017cbd16884f579cba9cc2' },
                    ...
                    { name: 'Isometric Hollow Hold March', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4f93f1ce04c2df307a1d925af8d6dd60' },
                    { name: 'Sit-Ups', movement: ['Core', 'Upper Abs'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/79c2e871bc05d0e758ecf46ea16bab6e' },
                    { name: 'Cable Crunches (Kneeling)', movement: ['Core', 'Upper Abs'], intent: ['Hypertrophy'], equipment: ['Cable'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b3b300edf71024eb5450b4702c3aa68e' },
                    { name: 'Jackknife Sit-Ups', movement: ['Core', 'Upper Abs'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a0655594ae073641dac84a773c20b9bb' },
                    { name: 'Weighted Crunches', movement: ['Core', 'Upper Abs'], intent: ['Hypertrophy'], equipment: ['Dumbbell', 'Plate'], contraindications: [], youtube: 'https://iframe.videodelivery.net/dea9894ff7124f78b33d478f1012e9c9' },
                    { name: 'Bicycle Crunches', movement: ['Core', 'Upper Abs', 'Obliques'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/17fefc954ede1b74161b987d84b7c92f' },
                    { name: 'Swiss Ball Pikes', movement: ['Core', 'Upper Abs'], intent: ['Strength'], equipment: ['Swiss Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/fedcbdc553df3bac33c5dacf88f8041b' },
                    { name: 'Ab Wheel Rollouts', movement: ['Core', 'Upper Abs'], intent: ['Strength'], equipment: ['Ab Wheel'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a9991fa5385295e0b9d8b58b4f10714c' },
                    { name: 'Turkish Get-Up Sit-Up', movement: ['Core'], intent: ['Functional Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c6be84da3dc668171cb21c22feff8a28' },
                    { name: 'Barbell Rollout from Knees', movement: ['Core', 'Anti-Extension'], intent: ['Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/fa2d9e4aa944963b9424f62e7fa24823' },
                    { name: 'Barbell Rollout from Feet', movement: ['Core', 'Anti-Extension'], intent: ['Max Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/990f84d235a45912bb516bd5a2f25ca5' },
                    { name: 'Barbell Sit-Up', movement: ['Core', 'Flexion'], intent: ['Hypertrophy'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/19ee7d74021e4713439f3a4f80d75d3b' },
                    { name: 'Barbell Ab Pullover', movement: ['Core', 'Anti-Extension'], intent: ['Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3beb91e349e03d334d0f92708f49c4c7' },
                    { name: 'Dumbbell Sit-Up', movement: ['Core', 'Flexion'], intent: ['Hypertrophy'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/36a96f3fb09517f6d5504d9a72b33e4d' },
                    { name: 'Dumbbell Toe Touch Crunch', movement: ['Core', 'Flexion'], intent: ['Hypertrophy'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6ba30c2d15b1bacdc1d6cc4cd1fc55ac' },
                    { name: 'Dumbbell Dead Bug Press', movement: ['Core'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/db3ea55f098c9495ee18a4ae841b5a4b', geriatric_priority: true },
                    { name: 'Dumbbell Plank Drag', movement: ['Core'], intent: ['Anti-Rotation'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3a0f3519f8c60411e5609be1f5b4772c' },
                    { name: 'Dumbbell Renegade Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/324a5fd849db5ff48b36e4c94e7ae590' },
                    { name: 'Dumbbell Bear Crawl Drag', movement: ['Core'], intent: ['Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1621317f017703e1d84b0499630f7125' },
                    { name: 'Dumbbell Hollow March', movement: ['Core'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/225d35d2b082c930ed2b6b7e08790f43' },
                    { name: 'Pelvic Tilts', movement: ['Core'], intent: ['Mobility', 'Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/bff0ce04c2915767b21b11fc231a317a', geriatric_priority: true },
                    { name: 'Cat-Cow Stretch', movement: ['Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ca3f741c7500fa62431fe65757c64647', geriatric_priority: true },
                    { name: 'Supine Breathing with 90/90', movement: ['Core'], intent: ['Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/67722d7b711a6f96314d490116f6ecf9', geriatric_priority: true },
                    ...
                    { name: 'Quadruped Rock Back', movement: ['Core'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/39a4c1a64d7786d3edcd160ebfd7cc90', geriatric_priority: true },
                    { name: 'Quadruped Hover Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/16f065c1195bd96e5e9709834c668e52' },
                    // --- New uploads 2026-06-20 ---
                    { name: 'Elbow Plank', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/bf4fe7c0644f746e0c563d10a88d3b0a' },
                    { name: 'Quadruped Hover Bear Walk', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e5308f0b6d106e551e125d1a23f5c372' },
                    { name: 'Hollow Hold 90/90 Iso Crunch', movement: ['Core', 'Upper Abs'], intent: ['Isometric Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0e01147bc3d74854fbe16805526a77b6' },
                    { name: 'Floor Crunches', movement: ['Core', 'Upper Abs'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/f4faad4d447aae54381772d14c104bae' },
                    { name: 'Arm Behind Back Diagonal Crunch', movement: ['Core', 'Upper Abs'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c7f674fc774c446c53e8ed718b89d654' }
                ]
            },
            oblique: {
                label: "Oblique",
                exercises: [
                    ...
                    // --- No video ---
                    { name: 'Standing Cable Chop (High to Low)', movement: ['Core', 'Obliques'], intent: ['Strength'], equipment: ['Cable'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8834555be876cc83ac77cb71ab4209f5' },
                    { name: 'Standing Cable Chop (Low to High)', movement: ['Core', 'Obliques'], intent: ['Strength'], equipment: ['Cable'], contraindications: [], youtube: 'https://iframe.videodelivery.net/212687cacb045e987dab40d74b9979ee' },
                    { name: 'Side Plank Hip Dips', movement: ['Core', 'Obliques'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3f3a73b168bc3da2b1380082e2e9116e' },
                    { name: 'Tall Kneeling Anti-Rotation Press', movement: ['Core', 'Anti-Rotation'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8fec4efba7850ab3f01f56cc32cdf3c9' },
                    { name: 'Landmine Rotations', movement: ['Core', 'Rotation'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/79c2f9d968dec12a18b31fa81157eaec' },
                    { name: 'Landmine Anti-Rotation Hold', movement: ['Core', 'Anti-Rotation'], intent: ['Stability'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/7c2040853cc92058f59a6ba4bb0b28cf' },
                    { name: 'Landmine Press (Split Stance)', movement: ['Core', 'Anti-Rotation'], intent: ['Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/619950356131d5495aacb7237728fafe' },
                    { name: 'Landmine Rainbow', movement: ['Core', 'Rotation'], intent: ['Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c3ee093d8cc86b3f7fba16124a6e9045' },
                    { name: 'Landmine Figure-8', movement: ['Core', 'Rotation'], intent: ['Power'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a03728c6663d31de9776d7babf7a4eae' },
                    { name: 'Landmine Lateral Raise to Press', movement: ['Core', 'Lateral Flexion'], intent: ['Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3237e75c2f70b17c5a2806cd23f783e1' },
                    { name: 'Landmine Windmill', movement: ['Core'], intent: ['Mobility', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4bb1821bd9824c50373544cb5bcc5730' },
                    { name: 'Dumbbell Side Bends', movement: ['Core'], intent: ['Hypertrophy'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/fcdb8fdca8aff5be4a6842f58fb1ffce', geriatric_priority: true },
                    { name: 'Dumbbell Windmill', movement: ['Core'], intent: ['Mobility', 'Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/f38d83acc78b98a5e0c46ae32a0ecabe' },
                    { name: 'Dumbbell Side Plank Row', movement: ['Core'], intent: ['Anti-Rotation'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/351b57b8e1cd7b2e6d4eaad9e537811f' },
                    { name: 'Dumbbell Pallof Press', movement: ['Core', 'Anti-Rotation'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/198c91b215e8f8a277e1d1fd29b7b387' },
                    { name: 'Dumbbell Side Bend Hold', movement: ['Core'], intent: ['Isometric Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1ec4153db3cd74745e3e4bb99323f37f' },
                    { name: 'Seated Anti-Rotation Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5d0e085c444bfbd500f872639688c6a4', geriatric_priority: true },
                    { name: 'Assisted Side Plank', movement: ['Core'], intent: ['Stability'], equipment: ['Bench'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0dc9f14dedea75bdbcca28b9b84bb84b', geriatric_priority: true },
                    // --- New uploads 2026-06-20 ---
                    { name: 'Standing Cable Lateral Chop', movement: ['Core', 'Obliques'], intent: ['Strength'], equipment: ['Cable'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4cbf3725bcf78baea49d1de941fc14a6' },
                    { name: 'Dumbbell Russian Twists', movement: ['Core', 'Obliques'], intent: ['Hypertrophy'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/50b8b8ac06b6bd506ae265006f4eace7' },
                    { name: 'Dumbbell Chop Low to High', movement: ['Core', 'Rotation'], intent: ['Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b62ebdf81801134b258b3865740d2848' }
                ]
            },
            lower: {
                label: "Lower",
                exercises: [
                    ...
                    // --- No video ---
                    { name: 'Hanging Knee Raises', movement: ['Core', 'Lower Abs'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/dd8f39b85c98bcc783b439a5b72b585a' },
                    { name: 'Hanging Leg Raises', movement: ['Core', 'Lower Abs'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0f0d42ab74584d4c9ca9dd4c23e5cbd8' },
                    { name: 'Toes to Bar', movement: ['Core', 'Lower Abs'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/f4a039b4772ded47ff8c2252b13537f7' },
                    { name: 'Lying Leg Raises', movement: ['Core', 'Lower Abs'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ea78f900048f1b8ce06a601e021b042b' },
                    { name: 'Lying Alternating Leg Lowers', movement: ['Core', 'Lower Abs'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e0cfc3261afef79e8a397c45ce1ffd08' },
                    { name: 'Decline Reverse Crunch', movement: ['Core', 'Lower Abs'], intent: ['Hypertrophy'], equipment: ['Bench'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b83d583966dff02ca33e43d86875c213' },
                    ...
                    { name: 'Hanging Knee Raise with Twist', movement: ['Core', 'Lower Abs', 'Obliques'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/da3dc3462849a3cd77fe75f6f9e028cf' },
                    { name: 'Lying Hip Thrusts', movement: ['Core', 'Lower Abs'], intent: ['Activation'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b213f539233f685ae0fcc969e11c73fe' },
                    { name: 'Landmine Dead Bug Press', movement: ['Core'], intent: ['Stability'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5dd9bae7214c684f40735f76cbda5ef6' },
                    { name: 'Barbell Split Squat Iso Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ae51bcbe089aea4f9891381f4e251add' },
                    { name: 'Dumbbell V-Sit Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/70b2a26bce6f9ac229362788c8aa8a03' },
                    { name: 'Bent Knee Fallout', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/17ccf199eaeb049fe12f11362879f921', geriatric_priority: true },
                    { name: 'Marching Dead Bug', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/bb419cac92a07fe94ead9dcdf09aa026', geriatric_priority: true },
                    { name: 'Wall Dead Bug', movement: ['Core'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c9097e201e30409ccc7ace0d6b20dc40', geriatric_priority: true },
                    // --- New uploads 2026-06-20 ---
                    { name: 'L-Sit Alternating Leg Hold', movement: ['Core', 'Lower Abs'], intent: ['Max Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/15fe6c5911b042619def141d6426a25b' },
                    { name: 'Captains Chair Knee Raises', movement: ['Core', 'Lower Abs'], intent: ['Strength'], equipment: ['Machine'], contraindications: [], youtube: 'https://iframe.videodelivery.net/dc263ae757d075c89ac6659dc516e8f5' }
                ]
            },
            functional: {
                label: "Functional",
                exercises: [
                    { name: 'GHR Side Crunch Hold', movement: ['Core'], intent: ['Stability'], equipment: ['Bench'], contraindications: [], youtube: 'https://iframe.videodelivery.net/334b95de037c74a5141925cf5f702607' },
                    { name: 'Half Kneeling Plate Chop', movement: ['Core'], intent: ['Stability'], equipment: ['Plate'], contraindications: [], youtube: 'https://iframe.videodelivery.net/69c24cd3ba7960b2aa78b54f27c9b38b' },
                    ...
                    { name: 'Band Pallof Press Circles', movement: ['Core'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/7dc077347f53151af74ad7fc92d72e8f' }
                ]
            }
        }
    },
        ...
        subcategories: {
            barbell: {
                ...
                exercises: [
                    ...
                    { name: 'Grace Complex (Clean + Push Jerk)', movement: ['Olympic'], intent: ['Power', 'Conditioning'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/66f0ecbe8e492c9f85703cdb18c79c96' },
                    { name: 'DT Complex', movement: ['Full Body'], intent: ['Strength', 'Conditioning'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6a97f3d3088f92b5f72ca193f8cf2b2d' },
                    { name: 'Barbell Cluster (Clean + Thruster)', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/706e790bd178b9cbf28899c9a71def5d' },
                    { name: 'Barbell Ground to Overhead', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/216ae71c3ede70072cacb159cf82925c' },
                    ...
                    { name: 'Barbell Devil Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b2b36a9ac5efadcc39b83a79cc57d98c' },
                    { name: 'Barbell Squat Clean Thruster', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/2b5f9600c1cb33b36ac13984b4da50ec' },
                    { name: 'Barbell Front Squat + Push Jerk', movement: ['Full Body'], intent: ['Strength'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/5b58767c6349fa7762f25a3ae62eb8c8' },
                    { name: 'Barbell Overhead Walking Lunge', movement: ['Full Body'], intent: ['Stability'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/d3edd1900a7137d19446aa6e883004c4' },
                    ...
                    { name: 'Barbell Snatch Pull + Power Snatch', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/bb1d8805ba66f88def2ca9c5beca7597' },
                    { name: 'Barbell Clean + Overhead Squat', movement: ['Olympic'], intent: ['Mobility', 'Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/69ee9c11b9ffb24f954871519bcfad6e' },
                    ...
                    { name: 'Barbell Squat Clean + Split Jerk', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/69effed54cc7f3e7b1c5f825520f0b91' },
                    ...
                    { name: 'Barbell Ground to Shoulder', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a8bc519dc3c1421a0bf15e8bcd2efe10' },
            ...
            dumbbell: {
                ...
                exercises: [
                    { name: 'Dumbbell Thruster', movement: ['Full Body'], intent: ['Power', 'Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b78632753c9593c996e6c65e394b756b' },
                    { name: 'Man Makers', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9117630dbeacd8f54d7451759e24f549' },
                    { name: 'Dumbbell Snatch', movement: ['Power', 'Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ef92f6768ed10385cf9b75fc7594aa5f' },
                    { name: 'Dumbbell Clean + Push Press', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4a62f894668a460ce7eb3ebf97d9f690' },
                    { name: 'Dumbbell Squat Clean Thruster', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ad8abf30199ff1967f680ee11f5ff72f' },
                    { name: 'Dumbbell Hang Clean + Front Squat', movement: ['Full Body'], intent: ['Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9baf47ba823e01ce9b10cd6d956f839b' },
                    { name: 'Dumbbell Lunge + Curl + Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1736a44b124be45e562e60fe9db729fb' },
                    { name: 'Dumbbell Ground to Overhead', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/be5595c866b6e3c9c88f978c8341c205' },
                    { name: 'Dumbbell Bear Complex', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/d68256ca0046514570ff9df660379a7c' },
                    { name: 'Dumbbell Snatch Alternating', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/83f5a8b952182a28c8d23c3c660521a8' },
                    { name: 'Dumbbell Squat + Press Ladder', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/13dbc70574309d93068c6d3df2dcfeec' },
                    { name: 'Dumbbell Complex (RDL + Row + Clean)', movement: ['Full Body'], intent: ['Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e7b07a36bc8435ff933071efa222d743' },
                    { name: 'Dumbbell Overhead Walking Lunge', movement: ['Full Body'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/19cbe63207efbdebcd1fdf85864d9cd2' },
                    { name: 'Dumbbell Farmer Carry into Thruster', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/64bc412613097ca2f64f6158e50a9398' },
                    { name: 'Dumbbell Power Clean + Push Jerk', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e067f1abd5302d208de7c465681a1962' },
                    { name: 'Dumbbell Lunge Matrix', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ab55d84239c2f027d1d47f284ca9ab4c' },
                    { name: 'Dumbbell Step-Up to Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5db91ecceae6c0153778a14b2fc1f81a' },
                    { name: 'Dumbbell Squat Clean + Push Press', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/dbf106e459a4d1b9719512083e62d5dd' },
                    { name: 'Dumbbell Ground Flow Complex', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/753959997cfbf1f2d6b258be7d545811' },
                    { name: 'Dumbbell Burpee Clean', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/d769bed97fc9eba0b2aedf795c119bcd' },
                    { name: 'Dumbbell Reverse Lunge + Curl + Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/83989445104170c35d1873a68795133e' },
                    { name: 'Dumbbell Hang Clean 1-1-Double', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/25d67b0fdbd0e84ceba553bd67544f27' },
                    { name: 'Dumbbell Cluster (Clean + Hang Clean + Snatch + Hang Snatch)', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/cd2aad1a95810f67bb681722638e97f5' },
                    { name: 'Dumbbell Walking Lunge + Curl + Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/54318e5b4834c2d03557098285f2ba8f' },
                    { name: 'Dumbbell Lunge Matrix + Curl + Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5849a9bf4b7d2c3a5dfc0c50064343a7' },
                    { name: 'Dumbbell Reverse Lunge + Step-Up to Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9d21fdf397701ed4eba82f851f9390c1' },
                    // --- Kettlebell ---
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Shuttle Sprint + Push-Ups', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/8c8279f92ce0f5f2de129c0d036d2dba' },
                    ...
                    { name: 'Sandbag Clean and Carry', movement: ['Full Body'], intent: ['Work Capacity'], equipment: ['Sandbag'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a73cfed2a4ec2387da44e6823217116a' },
                    { name: 'Bear Crawl + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ddf9952c91cf1dd72b532ce23d780d6c' },
                    ...
                    { name: 'Farmer Carry + Box Step-Up', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/545b2e2852423e5560ed690617bea086' },
                    { name: 'Sled Push', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Sled'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b893afb70b315a1c4e1386e68384439c' },
                    { name: 'Sled Push + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Sled'], contraindications: [], youtube: 'https://iframe.videodelivery.net/d0d954f3fa85a69099f1675b8e04e548' },
                    { name: 'Battle Rope Slams Alternating', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/275a4a9379727edc70b4d0e27f63e90f' },
                    { name: 'Battle Rope Slams Alternating + Burpee', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/661ee6e4ffcd1d1e75bf7a2c3e9fcaed' },
                    { name: 'Battle Rope Slams Double Arm', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/d23d29cc596ed8638b46dbafd4a78c49' },
                    { name: 'Battle Rope Slams Double + Burpee', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/43928a6e19f094fbaa24ecc0f6eed484' },
                    { name: 'Battle Rope Slams + Squats', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e721c35fb722d8ba537a3bcb8f8fcb92' },
                    { name: 'Battle Rope Slams + Lateral Lunge', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ac74165a9a8a0ecee9ef7266e655bf86' },
                    { name: 'Battle Rope Slams + Reverse Lunge', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ae6ad07f2dfd8598ec17cf5c4d5f6bfb' },
                    { name: 'Double Battle Rope Slams + Squats', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0b14d4570c4e7687e2bc66f10c0203e3' },
                    { name: 'Medicine Ball Clean', movement: ['Full Body'], intent: ['Power'], equipment: ['Medicine Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/44696ffbd8e9a57caf910022a0e606f3' },
                    { name: 'Medicine Ball Slam + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Medicine Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/89f629cd0adf46739efbe60927227663' },
                    { name: 'Ground-to-Shoulder Sandbag', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Sandbag'], contraindications: [], youtube: 'https://iframe.videodelivery.net/438a469f2b0c58a0bb3fa0cf44f226c5' },
                    { name: 'Tire Flip', movement: ['Full Body'], intent: ['Power'], equipment: ['Tire'], contraindications: [], youtube: 'https://iframe.videodelivery.net/872859b731cc8d6343a05af510164fdd' },
                    { name: 'Tire Flip + Jump In', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Tire'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0025b63727658ce02539d0e85c8abc24' },
                    { name: 'Stair Sprint Intervals', movement: ['Locomotion'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    { name: 'Farmer Carry Medley', movement: ['Carry'], intent: ['Work Capacity'], equipment: ['Implements'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1d06b8c0339ac217eccda02ae81b62c7' },
        ...
        subcategories: {
            ...
            functional: {
                ...
                exercises: [
                    ...
                    // --- No video ---,
                    { name: 'Pull + RDL + Hang Snatch + Back Squat to Press + Overhead Squat', movement: ['Olympic', 'Full Body'], intent: ['Power', 'Strength', 'Mobility'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/e944b2e6b4320e4eb4a14d1eb960ae99' },
                    { name: 'Pull + Hang Clean', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3b8defe1a353873ebf298fd4594239aa' },
                    { name: 'Pull + Hang Snatch', movement: ['Olympic'], intent: ['Power'], equipment: ['Barbell'], contraindications: ['No Overhead Loading'], youtube: 'https://iframe.videodelivery.net/68f0e9e969235d438fe11f60eb95360e' },
                    ...
                    { name: 'Pull + Power Clean', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9921ccca4699cadf29867d5ea724c3c3' },
                    { name: 'Hang Clean + Front Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3e9da075bab147c1770134adc57f77d2' },
                    { name: 'Pull + Power Snatch + Overhead Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/de28d23ffb37fc189ac833510083ce29' },
                    { name: 'Box Power Snatch + Overhead Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/74926f548952a8e4e79b4e159e6fcf5e' },
                    { name: 'Hang Snatch + Pull', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0eab9099bac06abea9aa2577af0e404e' },
                    { name: 'Slow Pull to Hang Clean + Front Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c2d75553940af692cebbcf1f9f1364fb' },
                    { name: 'Hang Clean + Front Squat + Push Press', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b5351ae15a0c6ca29854434f63cd803d' },
                    { name: 'RDL + Bent Over Row + Hang Clean', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1920e6168b6e1059585ca9c7d4c6c3cc' },
                    { name: 'Box Power Clean + Front Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/7d5891893bc47d867a3af4380aa6bf7e' },
                    { name: 'Hang Clean + Push Press', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/d45714ffb53c68cc8534f2ca848b2164' },
                    { name: 'Hang Clean + Push Jerk + Split Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c3bc92090e257c88b00fdbee0fb0b26f' },
                    { name: 'Hang Snatch + Overhead Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4c69d5e68c61c1dab766c6876a7a3446' },
                    { name: 'Hang Snatch + Slow pull to Clean + Hang Snatch + OHS', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/fde2844e8222b3eeba6f9e6b29967d5e' },
                    { name: 'Hang Snatch + Overhead Squat + Hang Snatch', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/19e9a2192b88f06b20824337cf7863cd' },
                    { name: 'Hang Clean + Power Clean + Front Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/92d204971305e105347b996bff36298c' },
                    { name: 'Pull + Hang Clean + Front Squat', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/805aa260143e387de72897b0942b6ddb' },
                    { name: 'Hang Snatch + Snatch Balance', movement: ['Olympic'], intent: ['Power', 'Strength'], equipment: ['Barbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9e025e7313dd9aa8a93bca399438adfa' }
                ]
            },
            corrective: {
                label: "Technique Work",
        ...
        subcategories: {
            ...
            corrective: {
                ...
                exercises: [
                    ...
                    { name: 'Bird Dog', movement: ['Brace'], intent: ['Corrective', 'Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/50789f485be2c5293981935598b49eac', geriatric_priority: true },
                    ...
                    { name: 'Side Plank (Modified on Knees)', movement: ['Brace'], intent: ['Stability', 'Corrective'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/1fff41217d4adc1e8ae52d37fed268d8', geriatric_priority: true },
                    ...
                    { name: 'Bent-Knee Fallout', movement: ['Brace'], intent: ['Corrective'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/17ccf199eaeb049fe12f11362879f921', geriatric_priority: true },
                    ...
                    { name: 'Seated Anti-Rotation Hold', movement: ['Brace'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5d0e085c444bfbd500f872639688c6a4', geriatric_priority: true },
        ...
        subcategories: {
            ...
            flexibility: {
                ...
                exercises: [
                    ...
                    { name: 'Butterfly Stretch', movement: ['Flexibility'], intent: ['Mobility', 'Recovery'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a2a0a2a3c868f34c9c11f0dad76e8193' },
