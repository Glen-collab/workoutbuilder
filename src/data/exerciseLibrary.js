        ...
        subcategories: {
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Broad Jumps', movement: ['Jump', 'Power'], intent: ['Power'], equipment: ['Bodyweight'], contraindications: ['Reduced Impact'], youtube: '' },
                    ...
                    { name: 'Split Squat', movement: ['Squat', 'Lunge'], intent: ['Strength'], equipment: ['Bodyweight'], contraindications: [], youtube: '', geriatric_priority: true },
                    { name: 'Reverse Lunges', movement: ['Lunge'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    ...
                    { name: 'Tempo Bodyweight Squats', movement: ['Squat'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    ...
                    { name: 'Assisted Pistol Squat', movement: ['Squat'], intent: ['Strength'], equipment: ['TRX', 'Band'], contraindications: [], youtube: '' },
                    { name: 'Box Pistol Squat', movement: ['Squat'], intent: ['Strength'], equipment: ['Box'], contraindications: [], youtube: '' },
                    { name: 'Sled Push', movement: ['Drive'], intent: ['Strength', 'Conditioning'], equipment: ['Sled'], contraindications: [], youtube: '' },
                    { name: 'Sled Drag (Forward)', movement: ['Drive'], intent: ['Hypertrophy'], equipment: ['Sled'], contraindications: [], youtube: '' },
                    { name: 'Sled Drag (Backward)', movement: ['Drive'], intent: ['Knee Health'], equipment: ['Sled'], contraindications: [], youtube: '', geriatric_priority: true },
                    ...
                    { name: 'Tempo Step-Ups', movement: ['Squat'], intent: ['Hypertrophy'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    ...
                    { name: 'Triple Threat (Stability Ball)', movement: ['Hip', 'Hinge'], intent: ['Hypertrophy', 'Endurance'], equipment: ['Stability Ball'], contraindications: [], youtube: '' },
            ...
            corrective: {
                ...
                exercises: [
                    ...
                    { name: 'Hamstring Stretch (Lying)', movement: ['Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: '', geriatric_priority: true },
                    { name: 'Ankle Mobility Drills', movement: ['Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: '', geriatric_priority: true },
                    ...
                    { name: 'Short Foot Drill', movement: ['Foot'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    { name: 'Toe Yoga', movement: ['Foot'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: '', geriatric_priority: true },
                    { name: 'Ankle CARs', movement: ['Mobility'], intent: ['Mobility'], equipment: ['Bodyweight'], contraindications: [], youtube: '', geriatric_priority: true },
