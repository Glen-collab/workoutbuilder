    ...
    legs: {
        ...
        subcategories: {
            ...
            functional: {
                label: "Functional",
                exercises: [
                    { name: 'Plate Overhead Split Squat', movement: ['Squat'], intent: ['Stability'], equipment: ['Plate'], contraindications: [], youtube: 'https://iframe.videodelivery.net/7e0bf3fe1c7777440aaa80d3b81f8e70' },
                    { name: 'Squat and Reach Up side to side', movement: ['Squat'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a0f9c4c56adc7d2087cc8f3cc288c31e' },
                    { name: 'Glute Extension Reach Backs', movement: ['Hip'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a4b312df06a0fbc0fd99b1a66bc596cc' },
                    { name: 'RDL Hip Openers', movement: ['Hinge'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b2740c6d0521b9104cdfb67223ca46eb' },
                    { name: 'Waiter Hold Opposite Knee Up Balance', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/2bbb25bd8782d6420c3804504b8d33df' },
                    { name: 'Standing Hip Circles with Balance', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5a318a85f538e66f960d54ae97ca5216' },
                    { name: 'Band Single Leg Hamstring Curl', movement: ['Hinge'], intent: ['Stability'], equipment: ['Band'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6d904adac77f96cd9f8d0abd44c356b5' },
                    { name: 'Dumbbell Step Behind Curtsy Lunge', movement: ['Single Leg'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/0d5d027e6dc03dcdee371c981e09601a' },
        ...
        subcategories: {
            ...
            dumbbell: {
                ...
                exercises: [
                    ...
                    { name: 'Dumbbell Complex (RDL + Row + Clean)', movement: ['Full Body'], intent: ['Strength'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ed8fe7055b128b9aa3d0292852ab412d' },
                    { name: 'Dumbbell Overhead Walking Lunge', movement: ['Full Body'], intent: ['Stability'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/ceb09f24f0a5152103303bda830176e0' },
                    { name: 'Dumbbell Farmer Carry into Thruster', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/e6809216fb53cb91bfc558d2920864e3' },
                    { name: 'Dumbbell Power Clean + Push Jerk', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/79ccbdb5275102798e509f568f7be47f' },
                    ...
                    { name: 'Dumbbell Ground Flow Complex', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/15d2834b8877d1b537919292f332f051' },
                    { name: 'Dumbbell Burpee Clean', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/999b37073663341c8f02f845de8a78b2' },
                    ...
                    { name: 'Dumbbell Cluster (Clean + Hang Clean + Snatch + Hang Snatch)', movement: ['Full Body'], intent: ['Power'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/af30d20cb10d0fd10d95b46ac335cc2d' },
                    ...
                    { name: 'Dumbbell Lunge Matrix + Curl + Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/296108cb0283183e864d4d55d4af8248' },
                    { name: 'Dumbbell Reverse Lunge + Step-Up to Press', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/a649909e84a1d21b69f10fb1d7efb201' },
                    // --- Kettlebell ---
            ...
            functional: {
                ...
                exercises: [
                    ...
                    { name: 'Shuttle Sprint + Push-Ups', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/9fd6b85548a59577847c191b57121f09' },
                    ...
                    { name: 'Sandbag Clean and Carry', movement: ['Full Body'], intent: ['Work Capacity'], equipment: ['Sandbag'], contraindications: [], youtube: 'https://iframe.videodelivery.net/09b89b106dc588c55e689feb6ef9af89' },
                    { name: 'Bear Crawl + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: 'https://iframe.videodelivery.net/6ba46a882aaa5d06d084f82c7793b9e2' },
                    ...
                    { name: 'Farmer Carry + Box Step-Up', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Dumbbell'], contraindications: [], youtube: 'https://iframe.videodelivery.net/c87385188225b9b81e6403c679c2aed1' },
                    ...
                    { name: 'Sled Push + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Sled'], contraindications: [], youtube: 'https://iframe.videodelivery.net/b47259b3a73f3aeffb893aa8621d5fa6' },
                    { name: 'Battle Rope Slams Alternating', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/847a2b464779cc3a88c7b7ac97212621' },
                    { name: 'Battle Rope Slams Alternating + Burpee', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/3b9e154f71bd5a94e70ddad4bddecc6d' },
                    { name: 'Battle Rope Slams Double Arm', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/859c9978ce1eed6d7e34bf06ac192fa7' },
                    { name: 'Battle Rope Slams Double + Burpee', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/491d96438a45d114acbf15045401f12e' },
                    { name: 'Battle Rope Slams + Squats', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/bc8b4181bf2b2ec4b05aa6919d51bd05' },
                    { name: 'Battle Rope Slams + Lateral Lunge', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/5ef8ddd224e710504077bcf61d1bf6c3' },
                    { name: 'Battle Rope Slams + Reverse Lunge', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/be3cdbdcda5f36e8a64322456f998372' },
                    { name: 'Double Battle Rope Slams + Squats', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Rope'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4865fceb0f461967175e00e06430ca0a' },
                    { name: 'Medicine Ball Clean', movement: ['Full Body'], intent: ['Power'], equipment: ['Medicine Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/97c020bb91daf0dd018143382d5d6050' },
                    { name: 'Medicine Ball Slam + Sprint', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Medicine Ball'], contraindications: [], youtube: 'https://iframe.videodelivery.net/4f0ed45b74c943ec7c03468b29a058cd' },
                    { name: 'Ground-to-Shoulder Sandbag', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Sandbag'], contraindications: [], youtube: 'https://iframe.videodelivery.net/deffd4a5d16d5cd551a7f620fe146644' },
                    ...
                    { name: 'Tire Flip + Jump In', movement: ['Full Body'], intent: ['Conditioning'], equipment: ['Tire'], contraindications: [], youtube: 'https://iframe.videodelivery.net/03c96ce0da7906926daed6d511f90d57' },
                    { name: 'Stair Sprint Intervals', movement: ['Locomotion'], intent: ['Conditioning'], equipment: ['Bodyweight'], contraindications: [], youtube: '' },
                    { name: 'Farmer Carry Medley', movement: ['Carry'], intent: ['Work Capacity'], equipment: ['Implements'], contraindications: [], youtube: 'https://iframe.videodelivery.net/35919ef88162e09644e3bb5b241542cb' },
